...
incl_ava_defs={
  ...
  avaPages:{
    ...
    'dd': {
      ...
      'reportBody':[
        {tag:'div',attr:{style:'width:60%;margin:0 auto;'},child:[
          ...
          {tag:'div',attr:{style:'margin-top:15px;',id:'depth_chart',className:'demo-placeholder span-6'}}
        ]}
      ],
      'reportDetail':[
        {tag:'div',child:[
    ...
    'sdb':{
      'title':["Survey Drawings","Dessins d'arpentage"],
      'mapInitState':true,
      'hasParameters':true,
      'hasAnimate':false,
      'longReport':true,
    ...
    'mb':{
      'title':["Map Browser","Navigateur de la carte"],
      'mapInitState':true,
      'hasParameters':true,
      'hasAnimate':false,
      'longReport':false,
